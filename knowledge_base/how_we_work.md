...
{{% alert title="Note" color="primary" %}} We are issue-first: all work, whether initiated by the Data team or a collaborator from another team, should begin with an issue in the GitLab Data Team project before any code is written or an MR is opened. This ensures work is visible, prioritized, and scoped before effort is invested {{% /alert %}}
